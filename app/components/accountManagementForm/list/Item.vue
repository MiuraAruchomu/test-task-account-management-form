<script setup>
import { useRecordUpdater } from '~/composables/useRecordUpdater';
...
const {
  ...
  changeType,
  removeRecord,
} = useRecordUpdater(props.data);
</script>

<template>
  <li class="my-3 grid grid-cols-[24%_15%_24%_24%_5%] gap-[2%]">
    <UiInput v-model="localTags" :error="errors.tags" @blur="updateTags" />
